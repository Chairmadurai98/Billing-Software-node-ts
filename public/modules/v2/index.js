...
const essential_route_1 = __importDefault(require("./essentials/essential.route"));
 ...
 */
v2Router.use("/essential", essential_route_1.default);
/**
 * @swagger
 * tags:
 *   name: Product
 ...
 *
 */
v2Router.use("/product", product_route_1.default);
/**
 * @swagger
 * tags:
 *   name: Order
 ...
 *
 */
v2Router.use("/order", order_route_1.default);
